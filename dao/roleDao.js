...
exports.insertRoles=function()
{
	...
	var firstNameList= new Array("Bing", "Michael", "Lucy","Kaushik", "Tom", "Hiller","David","Rose","peter","Daniel","lei","Johnson","William","Brown","Miller","Garcia","Martinez","Anderson","Moore","Lopez","Clark","Robinson","Walker","Hall","Allen","Sanchez","Scott","Adams","Campbell","Evans");
	...
	{  
		...
		var userId ="user"+ j;
		var iTemp1 = Math.floor(Math.random() * ( 29 + 1));
